...
(custom-theme-set-faces
 ...
 '(org-agenda-date ((((class color) (min-colors 89)) (:foreground "lavender" :height 1.1))))
 '(org-agenda-date-today ((((class color) (min-colors 89)) (:foreground "peach puff" :weight bold))))
 '(org-agenda-date-weekend ((((class color) (min-colors 89)) (:weight normal :foreground "cornflower blue"))))
 '(org-agenda-dimmed-todo-face ((((class color) (min-colors 89)) (:weight normal :foreground "azure3"))))
 ...
 '(org-scheduled-today ((((class color) (min-colors 89)) (:foreground "DeepSkyBlue2" :weight bold :height 1.2))))
 '(org-sexp-date ((((class color) (min-colors 89)) (:foreground "#bbbbbb"))))
 '(org-special-keyword ((((class color) (min-colors 89)) (:foreground "goldenrod2"))))
 ...
 '(org-warning ((((class color) (min-colors 89)) (:underline nil :foreground "#ff0000"))))
